  ...
  try {
    ...
    // Receive message to a channel
      ...
      if (parsedData.type === "message_ai") {
        ...
        //   if (enable_debug) {
        //     ws.send(JSON.stringify({ type: "ai_debug", response: {"phase": "ChatAiPreProcessing", "payload": pre_payload } }));
        //   }
        //   return;
        // }
        ...
        //   if (enable_debug) {
        //     ws.send(JSON.stringify({ type: "ai_debug", response: {"phase": "ChatAi", "payload": payload } }));
        //   }
        //   return;
        // }
        ...
        //   if (enable_debug) {
        //     ws.send(JSON.stringify({ type: "ai_debug", response: {"phase": "ChatAiPostProcessing", "payload": post_payload } }));
        //   }
        //   return;
        // }
        ...
        invokeChatAi(ws, enable_debug, 'ChatAi', message, username, channel, model_id, system_prompt, historyMessages);
      }
    }
...
function invokeChatAi(ws, enable_debug, functionName, message, username, channel, model_id, system_prompt, historyMessages) {
  try {
        ...
        try {
          ...
          if (payload.statusCode != 200) {
            ...
            if (enable_debug) {
              ...
              // Send AI response to client
              ws.send(JSON.stringify({ type: "ai_response", response_msg: payload.body.response_msg }));
          }
